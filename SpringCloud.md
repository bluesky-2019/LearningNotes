查看SpringCloud对应的SpringBoot版本

```json
网址：https://start.spring.io/actuator/info
{
  "git": {
    "branch": "17470056557679f0641f6bf653bcddacc53eb962",
    "commit": {
      "id": "1747005",
      "time": "2020-11-21T09:00:45Z"
    }
  },
  "build": {
...
![image-20201123175303024](SpringCloud.assets/image-20201123175303024.png)